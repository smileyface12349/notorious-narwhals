...
obj = FallingObject(position=Vector(relative_x=0.5, relative_y=0.5), collision=[1], z=1, elasticity=0.5)
obj.texture = SolidTexture(char="O", colour=1, obj=obj)
objects.append(obj)

obj = Wall(position=Vector(relative_x=0.4, relative_y=0.8), size=Vector(relative_x=0.2, y=1), collision=[1])
